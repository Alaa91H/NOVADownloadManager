...
const requiredActions: RequiredAction[] = [
  ...
  },
  {
    ...
    expected: 'pnpm/action-setup@v6.0.8',
    locations: ['.github/actions/setup-extension-ci/action.yml'],
  },
  {
...
const workflow = fileText.get('.github/workflows/ci.yml') ?? '';
...
const setupAction = fileText.get('.github/actions/setup-extension-ci/action.yml') ?? '';
