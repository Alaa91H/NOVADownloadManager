...
for (const term of [
  ...
  'chrome-extension://',
  'ADM_RUN_REAL_EXTENSION_E2E',
  'ADM_E2E_BROWSER_LAUNCH_TIMEOUT_MS',
  'ADM_E2E_EXTENSION_REGISTRATION_TIMEOUT_MS',
  'fs.mkdtempSync',
