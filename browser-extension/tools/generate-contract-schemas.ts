...
import { NovaEventSchema } from '../src/contracts/events.schema';
import { ExtensionSettingsResponseSchema } from '../src/contracts/nova.protocol.v4';

const BASE_ID = 'https://novadownloadmanager.app/contracts';
...
const targets = [
  ...
  { schema: NovaEventSchema, file: 'nova.events.schema.json', title: 'NOVA Bridge Event', id: 'nova.events.schema.json' },
