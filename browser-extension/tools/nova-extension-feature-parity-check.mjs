...
requireIncludes('src/content/overlay-ui.ts', 'adm-video-download-popover', 'smart overlay UI');
...
requireIncludes('src/ui/popup/PopupApp.tsx', 'adm-popup', 'desktop themed popup shell');
