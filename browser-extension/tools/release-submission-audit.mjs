...
const policyDocs = {
  'docs/PRIVACY.md': ['local', 'token', 'diagnostic', 'no telemetry'],
  'docs/SECURITY.md': ['token', 'redact', 'local-only', 'CSP'],
  'docs/PERMISSIONS.md': ['optional', '<all_urls>', 'downloads', 'webRequest'],
  'docs/STORE_COMPLIANCE.md': ['remote code', 'optional', 'privacy'],
  'docs/STORE_REVIEW_CHECKLIST.md': ['Chrome Web Store', 'permission', 'privacy'],
  'docs/STORE_PUBLISHING.md': ['build:store', 'release', 'review'],
  'docs/TESTING.md': ['Playwright', 'Vitest', 'pytest'],
  'docs/RELEASE.md': ['release', 'artifact', 'version'],
};
...
assertIncludes('.github/actions/setup-extension-ci/action.yml', 'version: 11.6.0', 'CI must pin pnpm 11.6.0.');
assertIncludes('.github/actions/setup-extension-ci/action.yml', 'node-version-file: .nvmrc', 'CI must use Node version from .nvmrc.');
assertIncludes('Dockerfile.ci', 'FROM node:24', 'Dockerfile.ci must pin a Node 24 base image.');
