...
def test_preflight_checks_overlay_terms_in_their_own_files() -> None:
    ...
    assert "assertFilesInclude(" in preflight
    assert "'src/content/overlay-ui.ts'" in preflight
    assert "'src/content/overlay-install.ts'" in preflight
    assert "'src/content/overlay-position.ts'" in preflight
    assert "'src/content/overlay-types.ts'" in preflight
