...
def test_video_overlay_is_positioned_configurable_draggable_and_edge_aware() -> None:
    ...
    assert "VIDEO_OVERLAY_HOST_ID = 'nova-video-download-overlay-host'" in scanner
    assert "VIDEO_OVERLAY_POSITION_STORAGE_KEY = 'nova.videoOverlayPosition.v1'" in scanner
...
def test_video_overlay_router_reports_filtering_and_diagnostics() -> None:
    ...
    assert 'nova.downloadOverlayPosition.v2.' in router
