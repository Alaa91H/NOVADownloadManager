...
export const AGGRESSIVE_CAPTURE_PROFILE = {
  ...
  enabledFeatures: [
    ...
    'downloads API absolute takeover — cancel browser downloads and hand off to NOVA',
...
export function applyAggressiveCaptureDefaults(settings: Settings): Settings {
  return {
    ...
    capture: {
      ...
      // Absolute takeover: NOVA claims every browser download.
