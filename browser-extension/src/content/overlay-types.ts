...
const VIDEO_OVERLAY_HOST_ID = 'nova-video-download-overlay-host';
const PICKER_HOST_ID = 'nova-candidate-picker-host';
const VIDEO_OVERLAY_RELAY_DATASET = 'novaVideoOverlayRelayInstalled';
const VIDEO_OVERLAY_DISCOVERY_SOURCE = 'nova-extension-video-overlay';
const VIDEO_OVERLAY_DISCOVERY_TYPE = 'video-candidate-detected';
const VIDEO_OVERLAY_LIVE_REFRESH_EVENT = 'nova-video-overlay-live-refresh';
...
const CANDIDATE_CACHE_STORAGE_PREFIX = 'nova.candidateCache.';
const VIDEO_OVERLAY_POSITION_STORAGE_KEY = 'nova.videoOverlayPosition.v1';
const DOWNLOAD_OVERLAY_POSITION_STORAGE_PREFIX = 'nova.downloadOverlayPosition.v2';
const VIDEO_OVERLAY_DESTROY_EVENT = 'nova-video-overlay-destroy';
const VIDEO_OVERLAY_USER_CLOSE_EVENT = 'nova-video-overlay-close';
const PICKER_DESTROY_EVENT = 'nova-candidate-picker-destroy';
