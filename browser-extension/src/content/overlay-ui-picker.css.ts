...
export function pickerCss(direction: string, _settings: OverlaySettings): string {
  return `
    ...
    .adm-picker-tool:hover { background: #eff6ff; border-color: #93c5fd; color: #1d4ed8; }
    ...
    .adm-picker-item input[type="checkbox"] {
      flex: 0 0 auto; margin-top: 2px; width: 16px; height: 16px; accent-color: #2563eb; cursor: pointer;
    }
    ...
    .adm-picker-item-size { color: #1d4ed8; background: #eff6ff; border-color: #bfdbfe; }
    ...
    .adm-picker-send:hover:not(:disabled) { background: linear-gradient(135deg, #1e40af, #1d4ed8); }
