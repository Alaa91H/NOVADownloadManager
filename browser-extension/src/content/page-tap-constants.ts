export const POST_SOURCE = 'adm-page-tap-v1';
export const POST_TYPE = 'ADM_PAGE_TAP_CANDIDATE';
export const DRM_CONFIG_TYPE = 'ADM_DRM_DETECTION_CONFIG';
export const DRM_POST_TYPE = 'ADM_DRM_DETECTION';
