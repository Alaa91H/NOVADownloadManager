...
const OVERLAY_POSITION_STORAGE_KEY = 'adm.videoOverlayPosition.v1';
const OVERLAY_POSITION_STORAGE_PREFIX = 'adm.downloadOverlayPosition.v2';
  ...
  return <section className="adm-section">
    <div className="adm-section-title-row">
      <div>
        ...
        <p className="adm-help">{t('overlay.options.subtitle')}</p>
      </div>
      <span className="adm-pill" data-tone={overlay.enabled ? 'success' : 'warning'}>{overlay.enabled ? t('overlay.options.visible') : t('overlay.options.disabled')}</span>
    </div>

    {notice ? <div className="adm-notice" data-kind="info" role="status">{notice}</div> : null}

    <div className="adm-card">
      <div className="adm-card-header">
        <div>
          <h3 className="adm-card-title">{t('overlay.options.positionBehavior')}</h3>
          <p className="adm-card-description">{t('overlay.options.positionBehaviorDescription')}</p>
        </div>
      </div>
    ...
    <div className="adm-card">
      <div className="adm-card-header">
        <div>
          <h3 className="adm-card-title">{t('overlay.options.visualTuning')}</h3>
          <p className="adm-card-description">{t('overlay.options.visualTuningHelp')}</p>
        </div>
      </div>
      <div className="adm-field-grid">
        <label className="adm-toggle">
    ...
    <div className="adm-card">
      <div className="adm-card-header">
        <div>
          <h3 className="adm-card-title">{t('overlay.options.smartFiltering')}</h3>{/* Smart filtering */}
          <p className="adm-card-description">{t('overlay.options.smartFilteringHelp')}</p>
        </div>
      </div>
      <div className="adm-field-grid">
        <label className="adm-toggle">
