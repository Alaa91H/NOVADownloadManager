  ...
  return <section className="nova-section">
    <div className="nova-section-title-row">
      <div>
        ...
        <p className="nova-help">{t('options.data.help')}</p>
      </div>
      <span className="nova-pill" data-tone="info">{t('options.data.localOnly')}</span>
    </div>
    {lastAction ? <div className="nova-notice" data-kind={lastAction.kind} role="status">{lastAction.message}</div> : null}
    ...
    {importJson.trim() ? <div className="nova-import-preview" data-valid={importPreview.valid}>
    ...
    <ConfirmDialog
      ...
      details={<ul className="nova-dialog-list">
