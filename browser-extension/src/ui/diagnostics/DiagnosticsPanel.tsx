      ...
      <div className="nova-page-shell">
        <header className="nova-topbar">
          <div className="nova-brand">
            <AppLogo />
            <div>
              <h1 className="nova-title">{t('diagnostics.title')}</h1>
              <p className="nova-subtitle">{t('diagnostics.subtitle')}</p>
            </div>
          </div>
        ...
        {loading ? (
          <div className="nova-notice" data-kind="info">
            {t('diagnostics.loading')}
          </div>
        ) : null}
        <div className="nova-diagnostics-grid">
          ...
          <section className="nova-section">
            ...
            <p className="nova-help">Direct engine: libcurl multi. Torrent/magnet is intentionally unsupported unless the daemon advertises a dedicated torrent capability.</p>
            <details className="nova-explain-details">
              <summary>Capability matrix</summary>
              <pre className="nova-explain-pre">{JSON.stringify({ items: capItems, directOptions, mediaOptions, engineCapabilities: engineCaps }, null, 2)}</pre>
            </details>
          </section>
          <section className="nova-section">
          ...
          <section className="nova-section nova-raw-block">
...
const Metric: React.FC<{
  ...
  return (
    <div className="nova-metric">
      ...
      <span className="nova-metric-label">
        {label}
        {tone ? ` · ${tone}` : ''}
      </span>
    </div>
