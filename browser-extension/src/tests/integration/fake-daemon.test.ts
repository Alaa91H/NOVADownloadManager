...
import { AddTaskResponseSchema, AuthCheckResponseSchema, PairResponseSchema, PingResponseSchema } from '../../contracts/nova.protocol.v4';
...
describe('fake NOVA daemon integration', () => {
