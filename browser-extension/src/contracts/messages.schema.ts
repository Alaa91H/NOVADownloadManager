...
import { StreamQualitySchema } from './adm.protocol.v4';
...
export const RuntimeMessageSchema = z.discriminatedUnion('type', [
  ...
  // Stream quality selector: resolve a manifest into concrete qualities via ADM,
  ...
  z.object({ type: z.literal('OPEN_ADM') }),
