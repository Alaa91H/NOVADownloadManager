                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  {taskToRemoveId === task.id ? (
                    ...
                    <button
                      ...
                      className="p-1.5 bg-[var(--bg-input)] hover:bg-red-500/10 text-red-500 hover:text-red-400 rounded-lg cursor-pointer border-transparent transition-all duration-150 hover:scale-[1.05] active:scale-[0.95]"
