    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen w-screen bg-[var(--bg-app)] text-[var(--text-primary)] gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-[var(--text-secondary)]">Connecting to daemon...</p>
        </div>
    ...
    >
      ...
      <div data-tauri-drag-region className="bg-[var(--bg-sidebar)] h-8 px-2 flex items-center justify-between text-[11px] font-semibold text-[var(--text-secondary)] select-none shrink-0" style={{ direction: 'ltr' }}>
        ...
        <div className="flex items-center h-full">
          <button onClick={() => getCurrentWindow().minimize()} className="h-full px-3 hover:bg-[var(--bg-hover)] transition-colors flex items-center justify-center cursor-pointer" title="Minimize">
            <Minus className="w-3 h-3 text-[var(--text-secondary)]" />
          </button>
          <button onClick={() => getCurrentWindow().toggleMaximize()} className="h-full px-3 hover:bg-[var(--bg-hover)] transition-colors flex items-center justify-center cursor-pointer" title="Maximize">
            <Square className="w-3 h-3 text-[var(--text-secondary)]" />
          </button>
          <button onClick={() => getCurrentWindow().close()} className="h-full px-3 hover:bg-red-500 hover:text-white transition-colors flex items-center justify-center cursor-pointer" title="Close">
