    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <span className="text-[11px] font-bold text-[var(--text-secondary)]">{'Max retry attempts per file:'}</span>
          <select
            value={retryCount}
            onChange={(e) => {
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xs text-[var(--text-muted)] font-bold">{'seconds between attempts'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-blue-500/5 border border-blue-500/10 text-[11px] text-[var(--text-secondary)] rounded-xl flex items-start gap-2.5 leading-relaxed shadow-sm">
        ...
        <div>
          <span className="font-bold text-[var(--text-primary)] block">{'Smart Link Verification:'}</span>
          {
