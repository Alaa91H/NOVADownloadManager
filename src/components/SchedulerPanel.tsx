...
export const SchedulerPanel: React.FC = () => {
  ...
  }, [name, isScheduled, startTime, endTime, days, limitSpeed, speedLimitKbs, oneTimeLimit, shutdownOnComplete, hangupOnComplete, retryCount, selectedQueueId, updateQueue]);
