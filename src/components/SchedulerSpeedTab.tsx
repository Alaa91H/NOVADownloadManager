    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between bg-[var(--bg-hover)]/40 p-3 rounded-lg border border-[var(--border-color)] shadow-sm">
        <div className="flex flex-col text-right">
          <span className="text-xs md:text-sm font-bold text-[var(--text-primary)]">{'Speed Limiter'}</span>
          <span className="text-[10px] text-[var(--text-muted)]">{'Limit speed to protect total bandwidth'}</span>
        </div>
        <input
          type="checkbox"
          checked={limitSpeed}
      ...
      {limitSpeed && (
        <div className="p-4 bg-[var(--bg-input)]/40 border border-[var(--border-color)] rounded-xl space-y-4 shadow-inner">
          ...
          <div className="flex items-center gap-2.5 text-xs text-[var(--text-secondary)] leading-relaxed bg-amber-500/5 border border-amber-500/10 p-3 rounded-lg">
            ...
            <span>{'Speed limit helps you browse websites smoothly while downloading in the background.'}</span>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center justify-between bg-[var(--bg-hover)]/40 p-3 rounded-lg border border-[var(--border-color)] shadow-sm">
        <div className="flex flex-col text-right">
          <span className="text-xs md:text-sm font-bold text-[var(--text-primary)]">{'One-time speed limit'}</span>
