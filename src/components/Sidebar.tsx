...
export const Sidebar: React.FC = () => {
  ...
  const accents: Array<{ id: AppThemeSettings['accent']; color: string; label: string }> = [
    { id: 'blue', color: 'bg-[var(--info)]', label: t('accent_blue') },
    { id: 'emerald', color: 'bg-[var(--success)]', label: t('accent_emerald') },
    { id: 'amber', color: 'bg-[var(--warning)]', label: t('accent_amber') },
    { id: 'crimson', color: 'bg-[var(--danger)]', label: t('accent_crimson') },
    { id: 'violet', color: 'bg-[var(--accent-primary)]', label: t('accent_violet') },
  ];
      ...
      <div className="space-y-5">
        ...
        >
          <div className="flex items-center gap-2">
            <span
              className={`w-2 h-2 rounded-full ${bridge.status === 'connected' ? 'bg-[var(--success)] animate-pulse' : 'bg-[var(--warning)]'}`}
            />
        ...
        <div className="space-y-0.5">
          ...
          >
            <span className="flex items-center gap-1.5">
              <Sliders className="w-3.5 h-3.5 text-[var(--warning)]" /> {t('compressed')}
            </span>
          ...
          >
            <span className="flex items-center gap-1.5">
              <Cpu className="w-3.5 h-3.5 text-[var(--success)]" /> {t('programs')}
            </span>
            <span className="bg-[var(--border-color)] px-1.5 py-0.5 rounded text-[10px] font-mono text-[var(--text-muted)]">
          ...
          >
            <span className="flex items-center gap-1.5">
              <Film className="w-3.5 h-3.5 text-[var(--info)]" /> {t('videos')}
            </span>
            <span className="bg-[var(--border-color)] px-1.5 py-0.5 rounded text-[10px] font-mono text-[var(--text-muted)]">
              {getTaskCount('video')}
            </span>
          ...
          >
            <span className="flex items-center gap-1.5">
              <Music className="w-3.5 h-3.5 text-[var(--accent-primary)]" /> {t('audio')}
            </span>
            <span className="bg-[var(--border-color)] px-1.5 py-0.5 rounded text-[10px] font-mono text-[var(--text-muted)]">
              {getTaskCount('audio')}
            </span>
          ...
          >
            <span className="flex items-center gap-1.5">
              <FileText className="w-3.5 h-3.5 text-[var(--danger)]" /> {t('documents')}
            </span>
            <span className="bg-[var(--border-color)] px-1.5 py-0.5 rounded text-[10px] font-mono text-[var(--text-muted)]">
        ...
        <div className="space-y-0.5">
          ...
          >
            <span className="flex items-center gap-1.5">
              <Globe className="w-3.5 h-3.5 text-[var(--info)]" /> {t('sidebar_system_browser')}
            </span>
            <span className="bg-[var(--success-bg)] border border-[var(--success-border)] text-[var(--success)] px-1 py-0.5 rounded text-[9px] font-bold">
              OS
            </span>
          </button>
        </div>
        ...
        <div className="space-y-0.5">
          ...
          >
            <span className="flex items-center gap-1.5">
              <Clock className="w-3.5 h-3.5 text-[var(--warning)] animate-pulse" /> {t('organize_scheduler')}
            </span>
            <span className="bg-[var(--warning-bg)] border border-[var(--warning-border)] text-[var(--warning)] px-1 py-0.5 rounded text-[9px] font-bold">
              {t('active_indicator')}
            </span>
          </button>
        </div>
