...
const defaultWidths: { [key: string]: number } = {
  name: 240, size: 96, progress: 160, speed: 110, timeLeft: 110,
  date: 130, status: 96, retries: 80, connections: 85,
  crc32: 90, priority: 95, completedDate: 130, sourceUrl: 180, smartCategory: 125,
};

const defaultCols: { [key: string]: boolean } = {
  name: true, size: true, progress: true, speed: true, timeLeft: true,
  date: true, status: true, retries: false, connections: false,
  crc32: false, priority: false, completedDate: false, sourceUrl: false, smartCategory: false,
};
