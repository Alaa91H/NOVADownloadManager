...
test.describe('Status Bar — clipboard monitor', () => {
  ...
  test('clipboard monitor button exists', async ({ page }) => {
    const clipBtn = page.locator('[role="status"] button[title*="clipboard" i], [role="status"] button[title*="حافظة" i]').first();
...
test.describe('Status Bar — telegram button', () => {
  ...
  test('telegram button exists', async ({ page }) => {
    const tgBtn = page.locator('[role="status"] button[title*="telegram" i], [role="status"] button[title*="تيليجرام" i]').first();
...
test.describe('Status Bar — notification bell', () => {
  ...
  test('notification bell button exists', async ({ page }) => {
    const bellBtn = page.locator('[role="status"] button[title*="notification" i], [role="status"] button[title*="إشعار" i]').first();
