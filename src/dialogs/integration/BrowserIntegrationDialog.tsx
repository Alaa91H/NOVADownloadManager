...
import { CheckCircle2, Chrome, Copy, Download, FolderOpen, Globe2, KeyRound, RefreshCw, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 text-left text-ui" dir="ltr">
      ...
      <div className="border border-[var(--border-color)] rounded-lg p-3 bg-[var(--bg-hover)]/25 space-y-2">
        ...
        <p className="text-[11px] text-[var(--text-secondary)] leading-relaxed">
          The browser extension packages are published as standalone files with every NOVA release:
          a Chrome/Chromium <code>.zip</code>, an Edge <code>.zip</code>, and a Firefox <code>.xpi</code>.
          Download the package for your browser, then load it from the extensions page.
        </p>
