...
export const GenericConfirmDialog: React.FC = () => {
  ...
  return (
    <div className="space-y-4 text-right" dir="auto">
      <div
        className={`flex items-center gap-3 p-3 rounded-lg border ${isDanger ? 'bg-red-500/10 border-red-500/20 text-red-500' : 'bg-blue-500/10 border-blue-500/20 text-blue-400'}`}
      >
