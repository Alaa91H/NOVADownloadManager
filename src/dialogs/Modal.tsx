...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md', role = 'dialog', id }) => {
  const { dialog, setActiveProgressMinimizedToTaskbar, setMinimizedProgressTask, closeDialog, t } = useAppStore();
