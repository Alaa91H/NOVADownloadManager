    ...
    <div className="space-y-4 text-left" dir="ltr">
      ...
      {loading ? (
        ...
        <div className="space-y-4 animate-in fade-in duration-150">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="bg-[var(--bg-hover)] border border-[var(--border-color)] p-3 rounded-lg flex flex-col gap-1">
              ...
              <span className="text-lg font-bold font-mono">
                {data.cpuUsage != null ? `${String(data.cpuUsage)}%` : 'N/A'}
              </span>
              <div className="w-full h-1.5 bg-[var(--bg-surface)] rounded-full overflow-hidden mt-1">
                <div className="bg-[var(--warning)] h-full" style={{ width: `${String(data.cpuUsage ?? 0)}%` }} />
              </div>
            </div>
          ...
          <div className="bg-[var(--bg-hover)] border border-[var(--border-color)] rounded-lg p-3 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-xs">
              ...
              <div className="flex justify-between border-b border-[var(--border-color)] py-1">
                ...
                <span className="font-medium font-mono text-left text-[var(--success)]">{data.daemonVersion}</span>
              </div>
              <div className="flex justify-between border-b border-[var(--border-color)] py-1">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 font-mono">
                      <span className="text-[var(--text-muted)]">{iface.ip}</span>
          ...
          <div className="flex gap-2 items-center p-2.5 bg-[var(--success-bg)] border border-[var(--success-border)] text-[var(--success)] rounded-lg text-[11px]">
