...
export const TaskPropertiesDialog: React.FC = () => {
  ...
  const formatBytes = (bytes: number) => {
    ...
    return `${parseFloat(temp.toFixed(2))} ${sizes[i]}`;
  };
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-col gap-1 text-ui">
          ...
          <div className="flex gap-2">
            <input
              ...
              style={{ direction: 'ltr' }}
            />
            <Button onClick={handlePickDirectory} variant="secondary" icon={HardDrive} size="sm">
              Change
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SelectField label="Category" value={category} onChange={(e) => setCategory(e.target.value as FileType)} options={categoryOptions} />
