...
export const YoutubeDownloadDialog: React.FC = () => {
  ...
  useEffect(() => {
    // When the runtime already reports post-processing as ready, ffmpeg
    // availability is derived below and needs no probe.
  ...
  // Ready runtime => available; otherwise fall back to the async probe result
  // (null while the probe is still pending).
        ...
        <div className="space-y-3 border-t border-[var(--border-color)]/50 pt-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              placeholder="Raw yt-dlp arguments are intentionally not sent by the production UI"
              className="w-full bg-[var(--bg-input)] border border-[var(--border-color)] rounded-md text-[11px] font-mono text-left text-[var(--text-primary)] p-2 focus:outline-none focus:border-[var(--accent-primary)]"
              style={{ direction: 'ltr' }}
              disabled
            />
