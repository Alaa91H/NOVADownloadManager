...
import { Video, ArrowRight, Magnet } from 'lucide-react';
...
export const AddDownloadDialog: React.FC = () => {
  ...
  }, [url, settings.saveAndCategories, defaultDownloadsDir, buildSavePath]);
      ...
      {showAdvanced && (
        <div className="p-2.5 bg-[var(--bg-sidebar)] border border-[var(--border-color)] rounded space-y-2.5 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center gap-6 pt-2">
            <Checkbox label={t('add_dl_resumable')} checked={resumable} onChange={setResumable} />
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <TextField
              ...
              value={minSplitSize}
              onChange={(e) => {
                setMinSplitSize(e.target.value);
              }}
              placeholder="1M"
            />
            <SelectField
              ...
              onChange={(e) => {
                setFileAllocation(e.target.value as 'none' | 'prealloc' | 'falloc' | 'trunc');
              }}
              options={[
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1">
            ...
            <Checkbox
              label="Use server filename when available"
              checked={contentDisposition}
              onChange={setContentDisposition}
            />
