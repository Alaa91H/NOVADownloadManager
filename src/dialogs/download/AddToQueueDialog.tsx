  ...
  return (
    <div className="space-y-4">
      <div className="flex gap-3 bg-[var(--bg-hover)] p-3 rounded-lg border border-[var(--border-color)]/30">
        <ArrowRightLeft className="w-5 h-5 text-[var(--info)] shrink-0 mt-0.5" />
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {q.scheduled && (
                    <span className="flex items-center gap-1 text-[10px] bg-[var(--warning-bg)] text-[var(--warning)] font-bold px-1.5 py-0.5 rounded">
