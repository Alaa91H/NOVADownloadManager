    ...
    storeRef.current = {
      ...
      t: (k: string) => {
        const map: Record<string, string> = {
          btn_cancel: 'Cancel',
          grabber_title: 'Professional Full Webpage Web Grabber',
          grabber_description: 'Download entire websites for offline viewing.',
          ...
          grabber_toast_backend_desc: 'Webpage mirroring is not connected to a real crawler backend yet.',
        };
        return map[k] || k;
      },
    };
