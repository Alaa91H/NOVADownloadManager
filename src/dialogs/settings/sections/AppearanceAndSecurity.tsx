...
interface Props {
  ...
  updateThemeSetting: (key: keyof AppThemeSettings, value: any) => void;
      ...
      <div className="space-y-4">
            ...
            <div className="flex gap-2.5 pt-1">
              {[
                ...
                <button
                  key={acc.id}
                  type="button"
                  onClick={() => updateThemeSetting('accent', acc.id as any)}
        ...
        <div className="grid grid-cols-1 gap-4">
          <SelectField
            ...
            onChange={(e) => updateThemeSetting('density', e.target.value as any)}
            options={[
          ...
          <SelectField
            ...
            onChange={(e) => updateThemeSetting('progress', e.target.value as any)}
            options={[
