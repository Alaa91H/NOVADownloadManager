    ...
    <div className="space-y-6 text-left animate-in fade-in duration-200">
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-indigo-400">{t('settings_browser_integration')}</h3>
        </div>
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          ...
          <FormRow label={t('settings_capture_browsers')}>
            <Switch
          ...
          <div className="flex flex-col gap-1.5 pt-1.5">
            <label className="text-[11px] text-slate-400 font-bold">{t('settings_pairing_token')}</label>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-2.5 bg-[var(--bg-hover)] hover:bg-[var(--border-color-hover)] text-slate-300 rounded border border-[var(--border-color)] cursor-pointer flex items-center justify-center"
              ...
              <button
                ...
                className="px-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded text-xs font-bold cursor-pointer"
              >
                {t('settings_generate_token')}
              </button>
            </div>
            <p className="text-[10px] text-slate-400 leading-relaxed">{t('settings_token_desc')}</p>
          </div>
          ...
          <div className="flex justify-end pt-2 border-t border-[var(--border-color)]/30">
            <button
              ...
              disabled={isPairing}
              className="px-3 py-1.5 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 rounded text-xs font-bold hover:bg-indigo-500/20 transition-all cursor-pointer flex items-center gap-1.5"
            >
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          ...
          <div className="space-y-1">
            <label className="text-[11px] text-slate-400 font-bold block">{t('settings_ignore_sites')}</label>
            <input
              type="text"
              value={ignoreSites}
              onChange={(e) => {
