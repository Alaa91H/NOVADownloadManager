    ...
    <div className="space-y-6 text-left animate-in fade-in duration-200">
      ...
      {activeSubTab === 'webhooks' && (
        <div className="space-y-4">
          <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
            <div className="flex items-center gap-2">
              <Link className="w-4 h-4 text-[var(--info)]" />
              <span className="text-[11px] font-extrabold text-[var(--info)]">{t('settings_webhook_endpoints')}</span>
            </div>
            ...
            <div className="border border-[var(--border-color)] rounded-lg overflow-hidden">
              <table className="w-full text-xs">
                ...
                <tbody>
                  ...
                  {webhooks.length === 0 && (
                    <tr>
                      <td colSpan={4} className="p-4 text-center text-[var(--text-muted)] italic">
        ...
        <div className="space-y-4">
          <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-extrabold text-[var(--info)]">{t('settings_smtp_alerts')}</span>
            </div>
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[var(--info-bg)] border border-[var(--info-border)] text-[var(--info)] rounded text-xs font-bold hover:bg-[var(--info-bg)] transition-all cursor-pointer"
            >
        ...
        <div className="space-y-4">
          <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-extrabold text-[var(--warning)]">{t('settings_automation_rules')}</span>
            </div>
            <button
              type="button"
              onClick={() => {
            ...
            <div className="space-y-2">
              <div className="bg-[var(--bg-input)]/50 border border-[var(--border-color)] rounded-lg p-3">
                <span className="text-xs font-extrabold text-[var(--text-primary)]">Rule: Organize large videos</span>
                <p className="text-[11px] text-[var(--text-muted)] mt-1">
                  If size is greater than 500 MB and type is video, move the file to /Videos/Large/ and send a
                  notification.
                </p>
                <span className="inline-block mt-2 bg-[var(--warning-bg)] border border-[var(--warning)]/30 text-[var(--warning)] text-[9px] font-bold px-1.5 py-0.5 rounded">
                  {t('settings_webhook_active')}
                </span>
              </div>
              <div className="bg-[var(--bg-input)]/50 border border-[var(--border-color)] rounded-lg p-3">
                <span className="text-xs font-extrabold text-[var(--text-primary)]">Rule: Critical failure alerts</span>
                <p className="text-[11px] text-[var(--text-muted)] mt-1">
                  If a download fails three times, run an external recovery command.
                </p>
                <span className="inline-block mt-2 bg-[var(--bg-hover)] border border-[var(--border-color)] text-[var(--text-muted)] text-[9px] font-bold px-1.5 py-0.5 rounded">
