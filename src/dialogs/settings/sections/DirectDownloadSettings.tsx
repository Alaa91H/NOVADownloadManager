...
import { Download, Clock, Shield, Network, HardDrive } from 'lucide-react';
    ...
    <div className="space-y-6 text-left animate-in fade-in duration-200">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-amber-400">Timeouts &amp; Retries</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-blue-400">Connection Tuning</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-emerald-400">HTTP / TLS</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-purple-400">Disk &amp; Memory</h3>
        </div>
