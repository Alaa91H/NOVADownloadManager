...
export const GeneralAndDownloads: React.FC<Props> = ({
  ...
  const handleOpenUpdate = async () => {
    ...
    await tauriClient.openExternalUrl(updateResult.installerUrl || updateResult.releaseUrl);
  };
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative flex items-center gap-1">
              ...
              <button
                type="button"
                onClick={() => { void handlePickDefaultFolder(); }}
                title="Browse"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative flex items-center gap-1">
              <input
                ...
                placeholder={defaultPathHint ? `${defaultPathHint}/.temp` : 'e.g. C:\\Users\\You\\Downloads\\NOVA\\.temp'}
                onChange={(e) => {
              ...
              <button
                type="button"
                onClick={() => { void handlePickTempFolder(); }}
                title="Browse"
                className="shrink-0 p-1.5 rounded border border-[var(--border-color)] bg-[var(--bg-hover)] hover:bg-[var(--bg-sidebar)] text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-colors cursor-pointer"
              >
                <Folder className="w-3.5 h-3.5" />
            ...
            {(
              ...
              <div key={cat} className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    type="button"
                    onClick={() => { void handlePickCategoryFolder(cat); }}
                    title="Browse"
                    className="shrink-0 p-1.5 rounded border border-[var(--border-color)] bg-[var(--bg-hover)] hover:bg-[var(--bg-sidebar)] text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-colors cursor-pointer"
                  >
                    <Folder className="w-3.5 h-3.5" />
