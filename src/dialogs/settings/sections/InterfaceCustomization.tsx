...
const customButtonActions: Array<{ value: CustomButtonAction; labelKey: string }> = [
  ...
  { value: 'youtubeDownload', labelKey: 'dlg_media_downloader' },
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-extrabold text-blue-400">{t('ui_toolbar_buttons')}</span>
          </div>
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-extrabold text-emerald-400">{t('ui_custom_buttons')}</span>
          </div>
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-extrabold text-amber-400">{t('ui_statusbar_icons')}</span>
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-emerald-400">{t('sound_alerts')}</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-blue-400">{t('shortcuts_title')}</h3>
        </div>
