    ...
    <div className="space-y-6 text-left animate-in fade-in duration-200">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-[var(--danger)]">Quality &amp; Format</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-[var(--info)]">Subtitles &amp; Languages</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-[var(--success)]">Stream Detection</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 border-b border-[var(--border-color)] pb-2">
          ...
          <h3 className="text-sm font-extrabold text-[var(--accent-primary)]">FFmpeg Integration</h3>
        </div>
        ...
        <div className="bg-[var(--bg-hover)]/30 p-3.5 rounded-lg border border-[var(--border-color)] space-y-3">
          ...
          <div className="flex flex-col gap-1.5 items-start pt-2 border-t border-[var(--border-color)]/30">
            <button
              ...
              className="px-3 py-1.5 bg-[var(--accent-light)] border border-[var(--accent-border)] text-[var(--accent-primary)] rounded text-xs font-bold hover:bg-[var(--accent-light)] transition-all cursor-pointer flex items-center gap-1"
            >
              {ffmpegStatus === 'detecting' && <RefreshCw className="w-3.5 h-3.5 animate-spin" />}
              {t('settings_detect_ffmpeg')}
            </button>
            {ffmpegStatus === 'found' && (
              <span className="bg-[var(--success-bg)] border border-[var(--success-border)] text-[var(--success)] px-2.5 py-0.5 rounded text-[10px] font-bold flex items-center gap-1">
                <CheckCircle2 className="w-3.5 h-3.5" /> {t('settings_ffmpeg_ready')}
              </span>
            )}
          </div>

          {ffmpegVersion && <p className="text-[11px] text-[var(--success)] font-mono mt-1">{ffmpegVersion}</p>}
        </div>
      </div>
    </div>
  );
