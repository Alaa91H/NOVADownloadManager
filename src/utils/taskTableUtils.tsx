...
import { Sliders, HardDrive, FileText, Cpu, Film, Music, Shield, HelpCircle } from 'lucide-react';
import { FileType } from '../types/desktop-ui.types';

export type SortColumn = 'name' | 'sizeBytes' | 'dateAdded' | 'status' | 'progress' | 'speed' | 'timeLeft' | 'retries' | 'connections' | 'crc32' | 'priority' | 'completedDate' | 'sourceUrl' | 'smartCategory';
...
export const getSortField = (colKey: string): SortColumn => {
  switch (colKey) {
    ...
    default: return colKey as SortColumn;
  }
};
