...
The only documentation allowed outside `docs/` is the root `README.md`. Extension documentation belongs in `docs/extension/`, release/store material belongs in `docs/release/`, and maintenance policy belongs in `docs/maintenance/`.
