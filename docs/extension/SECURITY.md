...
This build adds a runtime message trust-boundary guard, JSON-LD scan budgets, bounded site-rule imports/storage, a manifest source policy check, and diagnostics for active security budgets.
