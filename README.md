<p align="center">
  <img src="src/assets/logo.png" alt="NOVA Download Manager" width="150" height="150" />
</p>
...
<p align="center">
  <a href="https://ko-fi.com/alaa91h"><strong>Support NOVA on Ko-fi</strong></a>
  ·
  <a href="https://t.me/NOVADownloadManager"><strong>Telegram Channel</strong></a>
</p>

<p align="center">
  <img alt="Desktop" src="https://img.shields.io/badge/Desktop-Tauri%20%2B%20Rust-1f6feb" />
  <img alt="Engine" src="https://img.shields.io/badge/Direct%20Engine-libcurl%20multi-238636" />
  <img alt="Media" src="https://img.shields.io/badge/Media-yt--dlp%20%2B%20FFmpeg-8957e5" />
  <img alt="Extension" src="https://img.shields.io/badge/Extension-Manifest%20V3-f97316" />
  <img alt="Installer" src="https://img.shields.io/badge/Installer-NSIS%20Lifecycle-0ea5e9" />
</p>
...
The Windows installer uses Tauri NSIS with NOVA-branded artwork:

- `src-tauri/windows/installer-header.bmp`
- `src-tauri/windows/installer-sidebar.bmp`
- `src-tauri/windows/hooks.nsi`

The installer lifecycle covers install, upgrade, repair-style maintenance reinstall, uninstall, legacy artifact cleanup, Native Messaging registration, and Start Menu repair/uninstall shortcuts. User data is preserved unless the uninstaller is explicitly instructed to remove application data.
...
<p align="center">
  <a href="https://ko-fi.com/alaa91h"><strong>Support development on Ko-fi</strong></a>
  ·
  <a href="https://t.me/NOVADownloadManager"><strong>Follow the Telegram channel</strong></a>
</p>
