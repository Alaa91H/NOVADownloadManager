...
requireContains('src-tauri/windows/hooks.nsi', 'MUI_HEADERFONT "Segoe UI"', 'NSIS header font definition');
...
requireContains('.github/workflows/build.yml', 'SHA-256', 'release artifact checksums');
requireContains('.github/workflows/build.yml', 'build-metadata.json', 'build metadata generation');
requireContains('.github/workflows/build.yml', 'Build summary', 'professional build summary');
