...
requireContains('.github/workflows/build.yml', 'concurrency:', 'CI concurrency controls');
requireContains('.github/workflows/build.yml', 'timeout-minutes:', 'CI job timeout limits');
...
requireContains('.github/workflows/build.yml', 'SHA256SUMS', 'checksum generation');
requireContains('.github/workflows/build.yml', 'build-metadata.json', 'build metadata generation');
