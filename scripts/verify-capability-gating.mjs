...
requireNotContains('src/dialogs/download/AddDownloadDialog.tsx', 'extraArgs:', 'raw yt-dlp extraArgs in outbound payload');
...
requireNotContains('.github/workflows/ci.yml', 'browser-extension/.github', 'root workflow must not depend on nested extension workflow files');
