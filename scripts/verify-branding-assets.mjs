...
requireContains('scripts/generate-icons.ps1', 'branding\\source', 'canonical source folder default');

const artExts = new Set(['.png', '.ico', '.icns', '.bmp', '.webmanifest']);
const ignoredPrefixes = ['node_modules/', 'dist/', 'browser-extension/.output/', 'browser-extension/dist/'];
