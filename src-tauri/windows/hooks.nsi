...
!define MUI_HEADERFONT "Segoe UI" 12
!define MUI_TITLE "Segoe UI" 12
!define MUI_SUBTITLE "Segoe UI" 9
!define MUI_FONTSIZE 9
!define MUI_WELCOMEFINISHPAGE_FONT "Segoe UI" 11
!define MUI_UNWELCOMEFINISHPAGE_FONT "Segoe UI" 11
  ...
  ${If} $UpdateMode != 1
    IfFileExists "$INSTDIR\nova-install-receipt.ini" 0 nova_preinstall_no_upgrade
      ...
      ${If} $R0 != ""
        ...
        Pop $R0
        ; $R0 = 1 means this installer is newer → upgrade
        ${If} $R0 = 1
          StrCpy $UpdateMode 1
