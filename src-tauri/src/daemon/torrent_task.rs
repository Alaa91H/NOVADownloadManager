...
pub struct TorrentTaskDetails {
    ...
    pub dht_ipv4_port: Option<u16>,
    pub dht_ipv6_port: Option<u16>,
...
pub async fn torrent_task_details(
    ...
    Ok(TorrentTaskDetails {
        ...
        dht_ipv4_port: crate::daemon::torrent_dht::active_dht_ipv4_port(),
        dht_ipv6_port: crate::daemon::torrent_dht::active_dht_ipv6_port(),
