...
fn build_snapshot(state: &AppState) -> PersistedState {
    ...
    PersistedState { version: 1, aria2_meta, tasks, media_args, telegram_last_update_id }
}
...
mod tests {
    use super::*;
    use crate::daemon::types::{MediaJob, Segment, TorrentConfigBody};
    ...
    fn test_state(data_dir: &str) -> AppState {
        AppState {
            ...
            aria2_rpc_port: AtomicU16::new(6800),
            aria2_starting: AtomicBool::new(false),
