...
const CURL_DIRECT_OPTION_KEYS: &[&str] = &[
    "proxy", "preProxy", "noproxy", "proxyUser", "proxyAnyAuth", "proxyType", "proxyTunnel",
    "proxyCaInfo", "proxyCaPath", "proxyCert", "proxyCertType", "proxyKey", "proxyKeyType",
    "proxyKeyPassword", "proxyCiphers", "proxyTlsMax", "proxyTlsMin", "proxyVerifyPeer",
    "proxyVerifyHost", "sourceAddress", "interface",
    "userAgent", "referer", "headers", "cookies", "cookieJar", "username", "password", "authType",
    "oauth2Bearer", "netrc", "netrcOptional", "netrcFile", "unrestrictedAuth",
    ...
    "compressed", "transferEncoding", "http09Allowed", "expect100TimeoutMs",
    "insecure", "caCert", "caPath", "cert", "certType", "key", "keyType", "pass",
    "pinnedPubKey", "tlsMin", "tlsMax", "ciphers", "tls13Ciphers", "sslReqd",
    "sslOptions", "sslSessionIdCache", "crlFile", "issuerCert", "ipResolve",
    ...
    "pathAsIs", "globoff", "segmented", "forceSingleConnection",
...
fn checkable_features() -> HashSet<String> {
    ...
    [
        "ssl", "libz", "http2", "ipv6", "asynchdns", "https-proxy", "largefile", "ntlm"
